...
/*# sourceMappingURL=data:application/json;base64,${btoa(unescape(encodeURIComponent(JSON.stringify(a))))} */`),e.styleSheet)e.styleSheet.cssText=r;else{for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(document.createTextNode(r))}}var m=null,h=0;function g(e,t){var n,r,i;if(t.singleton){var a=h++;n=m||=l(t),r=f.bind(null,n,a,!1),i=f.bind(null,n,a,!0)}else n=l(t),r=p.bind(null,n,t),i=function(){(function(e){if(e.parentNode===null)return!1;e.parentNode.removeChild(e)})(n)};return r(e),function(t){if(t){if(t.css===e.css&&t.media===e.media&&t.sourceMap===e.sourceMap)return;r(e=t)}else i()}}e.exports=function(e,t){(t||={}).attributes=typeof t.attributes==`object`?t.attributes:{},t.singleton||typeof t.singleton==`boolean`||(t.singleton=a());var n=s(e,t);return c(n,t),function(e){for(var r=[],a=0;a<n.length;a++){var o=i[n[a].id];o&&(o.refs--,r.push(o))}e&&c(s(e,t),t);for(var l=0;l<r.length;l++){var u=r[l];if(u.refs===0){for(var d=0;d<u.parts.length;d++)u.parts[d]();delete i[u.id]}}}}},function(e,t,n){n.r(t);var r=n(0),i=n(3);n(5);function a(e){return r.createElement(`div`,{className:`loading-wrap`,style:e.style},r.createElement(`div`,{className:`circle-loading`}))}var o,s=n(1),c=n.n(s);function l(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)===`[object Arguments]`){var n=[],r=!0,i=!1,a=void 0;try{for(var o,s=e[Symbol.iterator]();!(r=(o=s.next()).done)&&(n.push(o.value),!t||n.length!==t);r=!0);}catch(e){i=!0,a=e}finally{try{r||s.return==null||s.return()}finally{if(i)throw a}}return n}}(e,t)||function(){throw TypeError(`Invalid attempt to destructure non-iterable instance`)}()}function u(e){var t=r.useRef(!1),n=r.useRef({x:0,y:0}),i=l(r.useState({x:0,y:0}),2),o=i[0],s=i[1];function u(t){e.onResize()}function d(r){r.button===0&&e.visible&&e.drag&&(r.preventDefault(),r.stopPropagation(),t.current=!0,n.current={x:r.nativeEvent.clientX,y:r.nativeEvent.clientY})}r.useEffect((function(){return function(){h(!0),m(!0)}}),[]),r.useEffect((function(){return m(),function(){m(!0)}})),r.useEffect((function(){return e.visible&&e.drag&&h(),!e.visible&&e.drag&&p({}),function(){h(!0)}}),[e.drag,e.visible]),r.useEffect((function(){var t=o.x-n.current.x,r=o.y-n.current.y;n.current={x:o.x,y:o.y},e.onChangeImgState(e.width,e.height,e.top+r,e.left+t)}),[o]);var f=function(e){t.current&&s({x:e.clientX,y:e.clientY})};function p(e){t.current=!1}function m(e){var t=`addEventListener`;e&&(t=`removeEventListener`),window[t](`resize`,u,!1)}function h(e){var t=`addEventListener`;e&&(t=`removeEventListener`),document[t](`click`,p,!1),document[t](`mousemove`,f,!1)}var g,_,v,y={width:`${e.width}px`,height:`${e.height}px`,transform:`
translateX(${e.left===null?`aoto`:e.left+`px`}) translateY(${e.top}px)
    rotate(${e.rotate}deg) scaleX(${e.scaleX}) scaleY(${e.scaleY})`},b=c()(`${e.prefixCls}-image`,(g={drag:e.drag},_=`${e.prefixCls}-image-transition`,v=!t.current,_ in g?Object.defineProperty(g,_,{value:v,enumerable:!0,configurable:!0,writable:!0}):g[_]=v,g)),x={zIndex:e.zIndex},S=null;return e.imgSrc!==``&&(S=r.createElement(`img`,{className:b,src:e.imgSrc,style:y,onMouseDown:d})),e.loading&&(S=r.createElement(`div`,{style:{display:`flex`,height:`${window.innerHeight-84}px`,justifyContent:`center`,alignItems:`center`}},r.createElement(a,null))),r.createElement(`div`,{className:`${e.prefixCls}-canvas`,onMouseDown:function(t){e.onCanvasMouseDown(t),d(t)},style:x},S)}function d(e){var t=e.activeIndex,n=t===void 0?0:t,i={marginLeft:`calc(50% - ${n+1} * 31px)`};return r.createElement(`div`,{className:`${e.prefixCls}-navbar`},r.createElement(`ul`,{className:`${e.prefixCls}-list ${e.prefixCls}-list-transition`,style:i},e.images.map((function(t,i){return r.createElement(`li`,{key:i,className:i===n?`active`:``,onClick:function(){var t;n!==(t=i)&&e.onChangeImg(t)}},r.createElement(`img`,{src:t.src,alt:t.alt}))}))))}function f(e){return r.createElement(`i`,{className:`react-viewer-icon react-viewer-icon-${o[e.type]}`})}(function(e){e[e.zoomIn=1]=`zoomIn`,e[e.zoomOut=2]=`zoomOut`,e[e.prev=3]=`prev`,e[e.next=4]=`next`,e[e.rotateLeft=5]=`rotateLeft`,e[e.rotateRight=6]=`rotateRight`,e[e.reset=7]=`reset`,e[e.close=8]=`close`,e[e.scaleX=9]=`scaleX`,e[e.scaleY=10]=`scaleY`,e[e.download=11]=`download`})(o||={});var p=[{key:`zoomIn`,actionType:o.zoomIn},{key:`zoomOut`,actionType:o.zoomOut},{key:`prev`,actionType:o.prev},{key:`reset`,actionType:o.reset},{key:`next`,actionType:o.next},{key:`rotateLeft`,actionType:o.rotateLeft},{key:`rotateRight`,actionType:o.rotateRight},{key:`scaleX`,actionType:o.scaleX},{key:`scaleY`,actionType:o.scaleY},{key:`download`,actionType:o.download}];function m(e,t){return e.filter((function(e){return t.indexOf(e.key)<0}))}function h(e){function t(t){var n=null;return o[t.actionType]!==void 0&&(n=r.createElement(f,{type:t.actionType})),t.render&&(n=t.render),r.createElement(`li`,{key:t.key,className:`${e.prefixCls}-btn`,onClick:function(){(function(t){e.onAction(t)})(t)},"data-key":t.key},n)}var n=e.attribute?r.createElement(`p`,{className:`${e.prefixCls}-attribute`},e.alt&&`${e.alt}`,e.noImgDetails||r.createElement(`span`,{className:`${e.prefixCls}-img-details`},`(${e.width} x ${e.height})`),e.showTotal&&r.createElement(`span`,{className:`${e.prefixCls}-showTotal`},`${e.activeIndex+1} of ${e.count}`)):null,i=e.toolbars;return e.zoomable||(i=m(i,[`zoomIn`,`zoomOut`])),e.changeable||(i=m(i,[`prev`,`next`])),e.rotatable||(i=m(i,[`rotateLeft`,`rotateRight`])),e.scalable||(i=m(i,[`scaleX`,`scaleY`])),e.downloadable||(i=m(i,[`download`])),r.createElement(`div`,null,n,r.createElement(`ul`,{className:`${e.prefixCls}-toolbar`},i.map((function(e){return t(e)}))))}function g(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function _(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)===`[object Arguments]`){var n=[],r=!0,i=!1,a=void 0;try{for(var o,s=e[Symbol.iterator]();!(r=(o=s.next()).done)&&(n.push(o.value),!t||n.length!==t);r=!0);}catch(e){i=!0,a=e}finally{try{r||s.return==null||s.return()}finally{if(i)throw a}}return n}}(e,t)||function(){throw TypeError(`Invalid attempt to destructure non-iterable instance`)}()}function v(){return(v=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}function y(){}var b={setVisible:`setVisible`,setActiveIndex:`setActiveIndex`,update:`update`,clear:`clear`};function x(e,t){return{type:e,payload:t||{}}}var S=function(e){var t,n=e.visible,i=n!==void 0&&n,a=e.onClose,s=a===void 0?y:a,l=e.images,m=l===void 0?[]:l,S=e.activeIndex,C=S===void 0?0:S,w=e.zIndex,T=w===void 0?1e3:w,E=e.drag,ee=E===void 0||E,te=e.attribute,ne=te===void 0||te,re=e.zoomable,ie=re===void 0||re,ae=e.rotatable,oe=ae===void 0||ae,se=e.scalable,ce=se===void 0||se,le=e.onMaskClick,ue=le===void 0?y:le,de=e.changeable,fe=de===void 0||de,pe=e.customToolbar,me=pe===void 0?function(e){return e}:pe,he=e.zoomSpeed,D=he===void 0?.05:he,ge=e.disableKeyboardSupport,_e=ge!==void 0&&ge,O=e.noResetZoomAfterChange,ve=O!==void 0&&O,k=e.noLimitInitializationSize,ye=k!==void 0&&k,A=e.defaultScale,j=A===void 0?1:A,M=e.loop,be=M===void 0||M,N=e.disableMouseZoom,xe=N!==void 0&&N,P=e.downloadable,Se=P!==void 0&&P,F=e.noImgDetails,Ce=F!==void 0&&F,I=e.noToolbar,we=I!==void 0&&I,Te=e.showTotal,Ee=Te===void 0||Te,De=e.minScale,L=De===void 0?.1:De,Oe={visible:!1,visibleStart:!1,transitionEnd:!1,activeIndex:e.activeIndex,width:0,height:0,top:15,left:null,rotate:0,imageWidth:0,imageHeight:0,scaleX:j,scaleY:j,loading:!1,loadFailed:!1,startLoading:!1};function R(){var t=window.innerWidth,n=window.innerHeight;return e.container&&(t=e.container.offsetWidth,n=e.container.offsetHeight),{width:t,height:n}}var z=r.useRef(R()),B=84,V=r.useRef(null),H=r.useRef(!1),ke=r.useRef(0),Ae=_(r.useReducer((function(e,t){switch(t.type){case b.setVisible:return v(v({},e),{visible:t.payload.visible});case b.setActiveIndex:return v(v({},e),{activeIndex:t.payload.index,startLoading:!0});case b.update:return v(v({},e),t.payload);case b.clear:return v(v({},e),{width:0,height:0,scaleX:j,scaleY:j,rotate:1,imageWidth:0,imageHeight:0,loadFailed:!1,top:0,left:0,loading:!1})}return e}),Oe),2),U=Ae[0],W=Ae[1];function G(t){var n=arguments.length>1&&arguments[1]!==void 0&&arguments[1];W(x(b.update,{loading:!0,loadFailed:!1}));var r=null;m.length>0&&(r=m[t]);var i=!1,a=new Image;function o(i,a,o){if(t===ke.current){var s=i,c=a;e.defaultSize&&(s=e.defaultSize.width,c=e.defaultSize.height),r.defaultSize&&(s=r.defaultSize.width,c=r.defaultSize.height);var l=_(K(s,c),2),u=l[0],d=l[1],f=(z.current.width-u)/2,p=(z.current.height-d-B)/2,m=j,h=j;ve&&!n&&(m=U.scaleX,h=U.scaleY),W(x(b.update,{width:u,height:d,left:f,top:p,imageWidth:i,imageHeight:a,loading:!1,rotate:0,scaleX:m,scaleY:h,loadFailed:!o,startLoading:!1}))}}a.onload=function(){H.current&&(i||o(a.width,a.height,!0))},a.onerror=function(){H.current&&(e.defaultImg?(W(x(b.update,{loading:!1,loadFailed:!0,startLoading:!1})),o(e.defaultImg.width||.5*z.current.width,e.defaultImg.height||.5*z.current.height,!1)):W(x(b.update,{loading:!1,loadFailed:!1,startLoading:!1})))},a.src=r.src,a.complete&&(i=!0,o(a.width,a.height,!0))}function K(e,t){var n=0,r=0,i=.8*z.current.width,a=.8*(z.current.height-B);return(r=(n=Math.min(i,e))/e*t)>a&&(n=(r=a)/t*e),ye&&(n=e,r=t),[n,r]}function q(t){if((be||!(t>=m.length||t<0))&&(t>=m.length&&(t=0),t<0&&(t=m.length-1),t!==U.activeIndex)){if(e.onChange){var n=J(t);e.onChange(n,t)}W(x(b.setActiveIndex,{index:t}))}}function J(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:void 0,t={src:``,alt:``,downloadUrl:``},n=null;return n=e===void 0?U.activeIndex:e,m.length>0&&n>=0&&(t=m[n]),t}function je(){var e=arguments.length>0&&arguments[0]!==void 0&&arguments[0];W(x(b.update,{rotate:U.rotate+90*(e?1:-1)}))}function Y(t){switch(t){case o.prev:q(U.activeIndex-1);break;case o.next:q(U.activeIndex+1);break;case o.zoomIn:var n=X();Z(n.x,n.y,1,D);break;case o.zoomOut:var r=X();Z(r.x,r.y,-1,D);break;case o.rotateLeft:je();break;case o.rotateRight:je(!0);break;case o.reset:G(U.activeIndex,!0);break;case o.scaleX:a=-1,W(x(b.update,{scaleX:U.scaleX*a}));break;case o.scaleY:(function(e){W(x(b.update,{scaleY:U.scaleY*e}))})(-1);break;case o.download:(i=J()).downloadUrl&&(e.downloadInNewWindow?window.open(i.downloadUrl,`_blank`):location.href=i.downloadUrl)}var i,a}function Me(){var e=`addEventListener`;arguments.length>0&&arguments[0]!==void 0&&arguments[0]&&(e=`removeEventListener`),_e||document[e](`keydown`,Ne,!0),V.current&&V.current[e](`wheel`,Pe,!1)}function Ne(e){var t=!1;switch(e.keyCode||e.which||e.charCode){case 27:s(),t=!0;break;case 37:e.ctrlKey?Y(o.rotateLeft):Y(o.prev),t=!0;break;case 39:e.ctrlKey?Y(o.rotateRight):Y(o.next),t=!0;break;case 38:Y(o.zoomIn),t=!0;break;case 40:Y(o.zoomOut),t=!0;break;case 49:e.ctrlKey&&(G(U.activeIndex),t=!0)}t&&(e.preventDefault(),e.stopPropagation())}function Pe(t){if(!xe&&!U.loading){t.preventDefault();var n=0,r=t.deltaY;if((n=r===0?0:r>0?-1:1)!=0){var i=t.clientX,a=t.clientY;if(e.container){var o=e.container.getBoundingClientRect();i-=o.left,a-=o.top}Z(i,a,n,D)}}}function X(){return{x:U.left+U.width/2,y:U.top+U.height/2}}function Z(t,n,r,i){var a=X(),o=t-a.x,s=n-a.y,c=0,l=0,u=0,d=0,f=0,p=0;if(U.width===0){var m=_(K(U.imageWidth,U.imageHeight),2),h=m[0],g=m[1];l=(z.current.width-h)/2,c=(z.current.height-B-g)/2,u=U.width+h,d=U.height+g,f=p=1}else{var v=U.scaleX>0?1:-1,y=U.scaleY>0?1:-1;f=U.scaleX+i*r*v,p=U.scaleY+i*r*y,e.maxScale!==void 0&&(Math.abs(f)>e.maxScale&&(f=e.maxScale*v),Math.abs(p)>e.maxScale&&(p=e.maxScale*y)),Math.abs(f)<L&&(f=L*v),Math.abs(p)<L&&(p=L*y),c=U.top+-r*s/U.scaleX*i*v,l=U.left+-r*o/U.scaleY*i*y,u=U.width,d=U.height}W(x(b.update,{width:u,scaleX:f,scaleY:p,height:d,top:c,left:l,loading:!1}))}r.useEffect((function(){return H.current=!0,function(){H.current=!1}}),[]),r.useEffect((function(){z.current=R()}),[e.container]),r.useEffect((function(){i&&H.current&&W(x(b.setVisible,{visible:!0}))}),[i]),r.useEffect((function(){return Me(),function(){Me(!0)}})),r.useEffect((function(){return i?e.container||(document.body.style.overflow=`hidden`,document.body.scrollHeight>document.body.clientHeight&&(document.body.style.paddingRight=`15px`)):W(x(b.clear,{})),function(){document.body.style.overflow=``,document.body.style.paddingRight=``}}),[U.visible]),r.useEffect((function(){i&&W(x(b.setActiveIndex,{index:C}))}),[C,i,m]),r.useEffect((function(){U.startLoading&&(ke.current=U.activeIndex,G(U.activeIndex))}),[U.startLoading,U.activeIndex]);var Q=`react-viewer`,Fe=c()(`${Q}`,`${Q}-transition`,(g(t={},`${Q}-inline`,e.container),g(t,e.className,e.className),t)),Ie={opacity:i&&U.visible?1:0,display:i||U.visible?`block`:`none`},$={src:``,alt:``};return i&&U.visible&&!U.loading&&U.activeIndex!==null&&!U.startLoading&&($=J()),r.createElement(`div`,{className:Fe,style:Ie,onTransitionEnd:function(){i||W(x(b.setVisible,{visible:!1}))},ref:V},r.createElement(`div`,{className:`${Q}-mask`,style:{zIndex:T}}),e.noClose||r.createElement(`div`,{className:`${Q}-close ${Q}-btn`,onClick:function(){s()},style:{zIndex:T+10}},r.createElement(f,{type:o.close})),r.createElement(u,{prefixCls:Q,imgSrc:U.loadFailed&&e.defaultImg.src||$.src,visible:i,width:U.width,height:U.height,top:U.top,left:U.left,rotate:U.rotate,onChangeImgState:function(e,t,n,r){W(x(b.update,{width:e,height:t,top:n,left:r}))},onResize:function(){if(z.current=R(),i){var e=(z.current.width-U.width)/2,t=(z.current.height-U.height-B)/2;W(x(b.update,{left:e,top:t}))}},zIndex:T+5,scaleX:U.scaleX,scaleY:U.scaleY,loading:U.loading,drag:ee,container:e.container,onCanvasMouseDown:function(e){ue(e)}}),e.noFooter||r.createElement(`div`,{className:`${Q}-footer`,style:{zIndex:T+5}},we||r.createElement(h,{prefixCls:Q,onAction:function(e){if(Y(e.actionType),e.onClick){var t=J();e.onClick(t)}},alt:$.alt,width:U.imageWidth,height:U.imageHeight,attribute:ne,zoomable:ie,rotatable:oe,scalable:ce,changeable:fe,downloadable:Se,noImgDetails:Ce,toolbars:me(p),activeIndex:U.activeIndex,count:m.length,showTotal:Ee}),e.noNavbar||r.createElement(d,{prefixCls:Q,images:e.images,activeIndex:U.activeIndex,onChangeImg:q})))};function C(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)===`[object Arguments]`){var n=[],r=!0,i=!1,a=void 0;try{for(var o,s=e[Symbol.iterator]();!(r=(o=s.next()).done)&&(n.push(o.value),!t||n.length!==t);r=!0);}catch(e){i=!0,a=e}finally{try{r||s.return==null||s.return()}finally{if(i)throw a}}return n}}(e,t)||function(){throw TypeError(`Invalid attempt to destructure non-iterable instance`)}()}t.default=function(e){var t=r.useRef(typeof document<`u`?document.createElement(`div`):null),n=C(r.useState(e.container),2),a=n[0],o=n[1],s=C(r.useState(!1),2),c=s[0],l=s[1];return r.useEffect((function(){document.body.appendChild(t.current)}),[]),r.useEffect((function(){e.visible&&!c&&l(!0)}),[e.visible,c]),r.useEffect((function(){e.container?o(e.container):o(t.current)}),[e.container]),c?i.createPortal(r.createElement(S,e),a):null}}])}))}));export default r();